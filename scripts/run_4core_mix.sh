...
trace1=`sed -n ''$num'p' /scratch/cluster/haowu/isb-meta/ChampSim_DPC3/sim_list/4core_regular_irregular.txt | awk '{print $1}'`
trace2=`sed -n ''$num'p' /scratch/cluster/haowu/isb-meta/ChampSim_DPC3/sim_list/4core_regular_irregular.txt | awk '{print $2}'`
trace3=`sed -n ''$num'p' /scratch/cluster/haowu/isb-meta/ChampSim_DPC3/sim_list/4core_regular_irregular.txt | awk '{print $3}'`
trace4=`sed -n ''$num'p' /scratch/cluster/haowu/isb-meta/ChampSim_DPC3/sim_list/4core_regular_irregular.txt | awk '{print $4}'`
